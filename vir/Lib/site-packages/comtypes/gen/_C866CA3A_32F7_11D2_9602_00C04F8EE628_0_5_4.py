...
__all__ = [
    ...
    'SpeechTokenShellFolder', 'DISPID_SPPsItem',
    'DISPID_SRRGetXMLResult', 'SVPAlert',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SRTStandard',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SRRSaveToMemory',
    'eLEXTYPE_RESERVED4', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SABufferNotifySize', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SPRDisplayAttributes', 'SLTUser',
    'DISPID_SpeechRecoResult2', 'SVP_19', 'SPXRO_Alternates_SML',
    'SSFMOpenReadWrite', 'SAFTADPCM_44kHzMono',
    'DISPID_SRSetPropertyString', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SLWsItem', 'DISPID_SLPLangId', 'SPRS_ACTIVE',
    'DISPID_SRCRetainedAudio', 'SRERequestUI', 'SPWORDPRONUNCIATION',
    'DISPID_SGRsItem', 'DISPID_SRCCmdMaxAlternates', 'SASClosed',
    'SWPKnownWordPronounceable', 'SPLO_STATIC', 'SPXRO_SML',
    'DISPID_SPISaveToMemory', 'SPPS_RESERVED1', 'SPBOOKMARKOPTIONS',
    'DISPID_SVIsUISupported', 'ISpeechAudioBufferInfo',
    'SAFT32kHz8BitMono', 'SPPS_Interjection',
    'SPEI_RECO_STATE_CHANGE', 'ISpStream', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SPELexicalForm', 'SpShortcut', 'SDTRule', 'SPWT_LEXICAL',
    'SpSharedRecoContext', 'DISPID_SGRSTPropertyValue',
    'SPPS_SuppressWord', 'DISPID_SRCERecognizerStateChange',
    'SPINTERFERENCE_NONE', 'DISPID_SDKSetLongValue',
    'SAFT24kHz8BitMono', 'DISPID_SOTGetDescription', 'SPEI_MIN_SR',
    'DISPID_SVAudioOutput', 'SREPhraseStart', 'eWORDTYPE_ADDED',
    'DISPID_SPRFirstElement', 'DISPID_SpeechPhraseElements',
    'DISPID_SRCState', 'SP_VISEME_1', 'SPSHT_NotOverriden',
    'DISPID_SRAudioInputStream', 'ISpAudio', 'SPSHORTCUTTYPE',
    'DISPID_SAFSetWaveFormatEx', 'SPPS_Function',
    'DISPID_SDKEnumValues', 'SPEI_UNDEFINED', 'SPWF_INPUT',
    'SPBO_NONE', 'DISPID_SPILanguageId', 'SVSFParseMask',
    'SpeechGrammarTagUnlimitedDictation', 'ISpObjectTokenCategory',
    'DISPID_SLWs_NewEnum', 'SPPS_Verb', 'SP_VISEME_9',
    'DISPID_SRRPhraseInfo', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SPRuleParent', 'eLEXTYPE_PRIVATE7', 'DISPID_SMSAMMHandle',
    'SPPARTOFSPEECH', 'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SOTsCount',
    'DISPID_SRRTTickCount', 'DISPID_SDKGetlongValue', 'ISpProperties',
    'SPRECOCONTEXTSTATUS', '__MIDL_IWinTypes_0009', 'SGSExclusive',
    'STCRemoteServer', 'tagSPTEXTSELECTIONINFO', 'SSFMCreate',
    'SAFT44kHz8BitStereo', 'ISpRecoContext2', 'ISpeechBaseStream',
    'DISPID_SPPFirstElement', 'ISpeechAudio', 'SPRULE',
    'DISPID_SGRSTRule', 'DISPID_SPRules_NewEnum', 'DISPID_SBSWrite',
    'SRTSMLTimeout', 'ISpRecognizer', 'SpFileStream',
    'DISPID_SPCLangId', 'SpeechRecognizerState', 'DISPID_SPACommit',
    'SPBO_AHEAD', 'DISPID_SRIsUISupported', 'DISPID_SPRuleConfidence',
    'SPRST_ACTIVE_ALWAYS', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SGRsCommitAndSave', 'SVSFVoiceMask',
    'SPEI_SENTENCE_BOUNDARY', 'SAFT11kHz16BitMono', 'SPBO_PAUSE',
    'DISPID_SGRsCount', 'ISpNotifyTranslator', 'SPLEXICONTYPE',
    'SPRST_INACTIVE', 'DISPID_SRCEAudioLevel', 'SPPHRASE',
    'eLEXTYPE_PRIVATE9', 'DISPID_SVSInputSentenceLength',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SVSpeakCompleteEvent',
    'SPDATAKEYLOCATION', 'SPEI_FALSE_RECOGNITION', 'SPEI_SR_PRIVATE',
    'SPPS_LMA', 'SREPropertyStringChange', 'SpeechRecognitionType',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SpeechTokenKeyUI',
    'SVEWordBoundary', 'SpResourceManager', 'SVSFPurgeBeforeSpeak',
    'SVF_Emphasis', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SPPValue', 'SVP_8', 'SAFT16kHz8BitStereo',
    'DISPID_SRCEPhraseStart', 'SpMMAudioIn', 'ISpeechPhraseProperty',
    'eLEXTYPE_RESERVED8', 'SAFT8kHz16BitMono', 'SP_VISEME_6',
    'ISpeechLexiconWords', 'IEnumString', 'ISpRecoResult',
    'DISPIDSPRG', 'DISPID_SpeechXMLRecoResult',
    'SAFTNoAssignedFormat', 'SRSEIsSpeaking', 'STSF_CommonAppData',
    'SpeechRuleState', 'DISPID_SPEDisplayText', 'SPWORD',
    'SRSActiveAlways', 'SVSFPersistXML', 'SREInterference',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SDKSetStringValue',
    'SDA_One_Trailing_Space', 'SPCT_COMMAND', 'SPPS_Unknown',
    'SPVPRI_ALERT', 'SpeechLexiconType', 'DISPID_SVSPhonemeId',
    'DISPIDSPTSI_SelectionOffset', 'SPSNotOverriden',
    'ISpeechRecoResult', 'eLEXTYPE_USER_SHORTCUT', 'SPSEMANTICFORMAT',
    'SPEI_SR_BOOKMARK', 'SPEI_PROPERTY_STRING_CHANGE',
    'STCInprocHandler', 'DISPID_SWFESamplesPerSec', 'SPPS_RESERVED3',
    'DISPID_SpeechRecoResultTimes', 'SpeechRunState',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SOTDataKey',
    'SDTDisplayText', 'SSSPTRelativeToEnd', 'SP_VISEME_18',
    'SpNullPhoneConverter', 'DISPID_SRDisplayUI',
    'SAFTGSM610_8kHzMono', 'ISpEventSink', 'DISPID_SPEsCount',
    'SPEI_RESERVED2', 'DISPID_SABIBufferSize',
    'SpeechCategoryAudioIn', 'DISPID_SpeechVoiceStatus',
    'SAFTDefault', 'DISPID_SOTIsUISupported',
    'SpeechCategoryRecognizers', 'DISPID_SADefaultFormat',
    'SPSEMANTICERRORINFO', 'eLEXTYPE_RESERVED10', 'SPVPRIORITY',
    'STSF_LocalAppData', 'SPEI_START_INPUT_STREAM', 'SVP_3',
    'DISPID_SRGSetWordSequenceData', 'SAFT48kHz8BitStereo',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SGRsFindRule',
    'SP_VISEME_2', 'DISPID_SPPId', 'SpeechTokenContext',
    'DISPID_SRCERecognitionForOtherContext', 'SPEI_MAX_SR',
    'SPPS_RESERVED4', 'DISPID_SABIEventBias',
    'Speech_Max_Pron_Length', 'SpeechVoiceEvents',
    'SpCompressedLexicon', 'SpeechTokenKeyFiles',
    'SpeechPropertyNormalConfidenceThreshold', 'SVP_10', 'SLODynamic',
    'SGDSActiveUserDelimited', 'SAFTCCITT_uLaw_11kHzMono',
    'SECFEmulateResult', 'ISpeechRecoResult2', 'SPFM_OPEN_READONLY',
    'DISPID_SGRSTs_NewEnum', 'ISpeechVoiceStatus', 'SDTLexicalForm',
    'SpeechEmulationCompareFlags', 'SAFT32kHz8BitStereo',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SpeechFileStream',
    'DISPID_SRCCreateGrammar', 'DISPID_SRCESoundStart',
    'SVEVoiceChange', 'SP_VISEME_15', 'DISPID_SpeechPhraseRules',
    'SAFT44kHz16BitStereo', 'DISPID_SPRs_NewEnum',
    'DISPID_SOTCDefault', 'eWORDTYPE_DELETED',
    'SpeechEngineProperties', 'DISPID_SVRate', 'ISpShortcut',
    'SpeechRuleAttributes', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SVGetProfiles', 'SREPropertyNumChange',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPAS_RUN',
    'SPINTERFERENCE_TOOLOUD', 'SAFTADPCM_11kHzMono', 'SPCS_DISABLED',
    'DISPID_SRGCmdLoadFromObject', 'SITooFast', 'SRAORetainAudio',
    'SDTAll', 'SPAS_PAUSE', 'SVPOver', 'ISpResourceManager',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SVEAudioLevel',
    'DISPID_SRGState', 'DISPID_SpeechGrammarRule',
    'SGDSActiveWithAutoPause', 'SECHighConfidence', 'SGRSTTWildcard',
    'DISPID_SABufferInfo', 'Speech_StreamPos_RealTime',
    'DISPID_SRCVoicePurgeEvent', 'SDA_Consume_Leading_Spaces',
    'ISpeechPhoneConverter', 'DISPID_SVSCurrentStreamNumber',
    'SP_VISEME_21', 'SPWAVEFORMATTYPE', 'STCInprocServer',
    'DISPID_SLGenerationId', 'SPRST_NUM_STATES', 'SP_VISEME_11',
    'SPEI_START_SR_STREAM', 'SpAudioFormat', 'SPEI_END_SR_STREAM',
    'SPAUDIOSTATUS', 'DISPID_SGRSAddWordTransition',
    'DISPID_SWFEBitsPerSample', 'DISPID_SGRSTText',
    'SAFTADPCM_11kHzStereo', 'DISPID_SRCResume',
    'SpeechSpecialTransitionType', 'ISpeechRecognizer',
    'ISpeechPhraseAlternate', 'SPWF_SRENGINE', 'eLEXTYPE_APP',
    'SPDKL_CurrentConfig', 'SAFT48kHz16BitStereo', 'SVSFIsNotXML',
    'SGRSTTEpsilon', 'DISPID_SLPsCount', 'SRERecognition',
    'DISPID_SOTCreateInstance', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SGRAttributes', 'SPLOADOPTIONS',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SPRuleName',
    'ISpeechPhraseRule', 'eLEXTYPE_PRIVATE14',
    'DISPID_SPEEngineConfidence', 'SpObjectToken',
    'SAFTCCITT_ALaw_44kHzStereo', 'ISpObjectToken', 'SITooLoud',
    'SpeechAudioFormatType', 'SPTEXTSELECTIONINFO',
    'SPWORDPRONOUNCEABLE', 'SVP_1', 'SPINTERFERENCE_TOOFAST',
    'SAFT12kHz8BitStereo', 'DISPID_SRGCmdSetRuleIdState', 'SITooSlow',
    'DISPID_SVSLastBookmark', 'SpVoice', 'SGRSTTTextBuffer',
    'SPRECOGNIZERSTATUS', 'SPPHRASEPROPERTY', 'SPSSuppressWord',
    'ISpeechPhraseElement', 'ISpStreamFormatConverter', 'SPSModifier',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SpeechAudioFormat',
    'DISPID_SpeechRecognizer', 'eLEXTYPE_PRIVATE15',
    'DISPID_SpeechLexiconProns', 'DISPID_SVSLastBookmarkId',
    'DISPID_SVEStreamEnd', 'DISPID_SBSRead', 'DISPID_SpeechAudio',
    'SGSDisabled', 'ISpeechGrammarRule', 'SAFTNonStandardFormat',
    'DISPID_SLWLangId', 'SPEI_RESERVED3', 'SpeechRecoContextState',
    'SAFTADPCM_8kHzStereo', 'DISPID_SREmulateRecognition',
    'DISPID_SPIProperties', 'DISPID_SpeechBaseStream', 'SVP_2',
    'SPWORDTYPE', 'SpeechGrammarTagWildcard', 'SVSFUnusedFlags',
    'SAFT11kHz8BitStereo', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'ISpStreamFormat', 'SpeechEngineConfidence',
    'SpeechPropertyResponseSpeed', 'SREBookmark',
    'SAFTADPCM_22kHzMono', 'SAFT12kHz8BitMono', 'SVEViseme',
    'SRTEmulated', 'SWPUnknownWordUnpronounceable',
    'SSSPTRelativeToStart', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SRGReset', 'DISPID_SLGetPronunciations',
    'SGRSTTDictation', 'DISPID_SMSGetData', 'DISPID_SPRsItem',
    'STCAll', 'ISpeechRecoContext', 'SVP_6', 'ISpVoice',
    'SpeechRegistryUserRoot', 'SP_VISEME_7', 'eLEXTYPE_PRIVATE5',
    'SECLowConfidence', 'DISPID_SGRSTsCount',
    'DISPID_SRGDictationSetState', 'SpeechRecoEvents',
    'ISpNotifySink', 'DISPID_SpeechPhraseProperty',
    'DISPID_SDKGetBinaryValue', 'SAFTCCITT_ALaw_11kHzStereo',
    'SRESoundEnd', 'DISPID_SRCBookmark',
    'DISPID_SPERequiredConfidence', 'SpeechDictationTopicSpelling',
    'DISPID_SPPs_NewEnum', 'DISPID_SPIEngineId',
    'DISPID_SPEActualConfidence', 'SPAS_CLOSED',
    'DISPID_SGRSTPropertyName', 'ISpeechAudioFormat', 'SGSEnabled',
    'DISPID_SpeechMMSysAudio', 'SPPS_Noun', 'DISPID_SVStatus',
    'SASRun', 'DISPID_SOTRemove', 'DISPID_SRCVoice',
    'SVSFNLPSpeakPunc', 'SVEEndInputStream', 'SVP_17',
    'SPEI_REQUEST_UI', 'DISPID_SRGCmdLoadFromFile', 'eLEXTYPE_USER',
    'SPSERIALIZEDRESULT', 'SPINTERFERENCE_LATENCY_WARNING',
    'ISpeechFileStream', 'IStream', 'SpMMAudioOut', 'SP_VISEME_19',
    'eLEXTYPE_PRIVATE12', 'SpeechPropertyResourceUsage',
    'SPFM_NUM_MODES', 'SFTSREngine', 'DISPID_SOTsItem', 'SPEI_VISEME',
    'DISPID_SPCIdToPhone', 'ISpLexicon', 'DISPID_SGRAddState',
    'SPFM_CREATE_ALWAYS', 'SAFT22kHz16BitMono',
    'SAFTCCITT_uLaw_44kHzStereo', 'SP_VISEME_12',
    'ISpeechPhraseReplacements', 'SAFT32kHz16BitMono', 'SP_VISEME_5',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SpeechVoiceEvent',
    'DISPID_SMSADeviceId', 'DISPID_SBSFormat',
    'Speech_Default_Weight', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SVAlertBoundary', 'SPWT_DISPLAY', 'DISPID_SRGRecoContext',
    'DISPID_SPRulesItem', 'SPWORDLIST', 'SPSUnknown',
    'DISPID_SPEDisplayAttributes', 'DISPID_SLRemovePronunciation',
    'SGRSTTWord', 'eLEXTYPE_VENDORLEXICON', 'SGDSInactive',
    'DISPID_SVSInputWordLength', 'DISPID_SPRuleNumberOfElements',
    'eLEXTYPE_PRIVATE8', 'SRCS_Enabled', 'ISpRecoCategory',
    'DISPID_SRCEFalseRecognition', 'DISPID_SFSClose',
    'SAFTADPCM_44kHzStereo', 'SPPS_RESERVED2', 'SpStream',
    'DISPID_SRSCurrentStreamPosition', 'SpeechVisemeFeature',
    'SpeechCategoryAppLexicons', 'SASStop', 'DISPID_SOTId',
    'SPBO_TIME_UNITS', 'DISPID_SVEViseme',
    'DISPID_SRGetPropertyNumber', 'Speech_Max_Word_Length',
    'DISPID_SRCRecognizer', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SVGetAudioOutputs', 'DISPID_SPPsCount',
    'SpeechDiscardType', 'SpeechAllElements',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SPPBRestorePhraseFromMemory',
    'SPRST_ACTIVE', 'SPRS_INACTIVE', 'ISpPhoneticAlphabetConverter',
    'DISPID_SPPName', 'SVF_None', 'SpeechStreamSeekPositionType',
    'SPINTERFERENCE_NOISE', 'DISPID_SRRTLength', 'eLEXTYPE_PRIVATE1',
    'SpeechAudioFormatGUIDWave', 'eLEXTYPE_PRIVATE20',
    'SDA_No_Trailing_Space', 'DISPID_SGRs_NewEnum',
    'SpTextSelectionInformation', 'SpeechGrammarWordType',
    'ISequentialStream', 'SpCustomStream', 'SAFT16kHz16BitStereo',
    'ISpeechXMLRecoResult',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SVSFNLPMask',
    'ISpPhrase', 'DISPID_SRCPause', 'eLEXTYPE_PRIVATE17',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SPIRule',
    'SpPhraseInfoBuilder', 'DISPID_SPPEngineConfidence', 'SPCT_SLEEP',
    'DISPID_SRProfile', '_ISpeechRecoContextEvents', 'SP_VISEME_0',
    'DISPID_SPARecoResult', 'SP_VISEME_17', 'eLEXTYPE_PRIVATE6',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPPS_Modifier',
    'DISPID_SRCEBookmark', 'SpeechUserTraining', 'DISPID_SVResume',
    'DISPID_SRSetPropertyNumber', 'SPEI_MAX_TTS', 'tagSTATSTG',
    'DISPID_SPEAudioSizeTime', '_SPAUDIOSTATE',
    'DISPID_SRCreateRecoContext', 'SPAR_Unknown',
    'DISPID_SpeechMemoryStream', 'SRCS_Disabled',
    'DISPID_SVEventInterests', 'SPAUDIOOPTIONS', 'DISPID_SRIsShared',
    'SpeechRetainedAudioOptions', 'SAFT8kHz16BitStereo',
    'SpeechDataKeyLocation', 'ISpeechTextSelectionInformation',
    'SAFT16kHz16BitMono', 'SpNotifyTranslator', 'DISPID_SOTDisplayUI',
    'DISPID_SPEsItem', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SPANumberOfElementsInResult', 'SVP_13',
    'SAFT24kHz16BitMono', 'DISPID_SGRName',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SRGIsPronounceable',
    'SVSFIsFilename', 'DISPID_SVEPhoneme', 'SPPHRASEREPLACEMENT',
    'DISPIDSPTSI_ActiveOffset', 'SpeechAudioVolume',
    'SPPHRASEELEMENT', 'SpeechTokenKeyAttributes', 'DISPID_SFSOpen',
    'DISPID_SDKDeleteKey', 'SpMMAudioEnum', 'eLEXTYPE_PRIVATE3',
    'ISpRecoContext', 'DISPID_SGRSRule', 'SpeechAudioProperties',
    'SPINTERFERENCE_TOOQUIET', 'ISpeechMMSysAudio',
    'DISPID_SRGDictationUnload', 'SPEI_PHRASE_START',
    'SPEI_INTERFERENCE', 'SREStateChange', 'DISPID_SRGId',
    'SPRST_INACTIVE_WITH_PURGE', 'SREAdaptation', 'SREStreamStart',
    'DISPID_SPPConfidence', 'SVPNormal', 'ISpeechPhraseAlternates',
    'SPSInterjection', 'DISPID_SVVoice', 'SWTDeleted',
    'DISPID_SAStatus', 'SDKLLocalMachine', 'SpeechDisplayAttributes',
    'DISPID_SOTCId', 'eLEXTYPE_RESERVED9', 'STCLocalServer',
    'SAFTTrueSpeech_8kHz1BitMono', 'SECFIgnoreKanaType',
    'DISPID_SRRAudioFormat', 'SRAInterpreter', 'SPCATEGORYTYPE',
    'SAFTText', 'SREAllEvents', 'SVEAllEvents',
    'ISpeechRecognizerStatus', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SVSkip', 'SPEVENTSOURCEINFO', 'SPEI_RECOGNITION',
    'ISpXMLRecoResult', 'SAFTExtendedAudioFormat', 'SVP_21',
    'ISpeechLexiconPronunciation', 'SPSFunction',
    'SAFTCCITT_ALaw_8kHzStereo', 'SAFTADPCM_8kHzMono',
    'DISPID_SPIGetText', 'SpeechBookmarkOptions',
    'DISPID_SLPPhoneIds', 'DISPID_SpeechCustomStream',
    'DISPID_SVSpeakStream', 'DISPID_SGRSTWeight',
    'DISPID_SGRSAddRuleTransition', 'ISpeechRecoGrammar',
    'DISPID_SPAStartElementInResult', 'DISPID_SRCEEndStream',
    'SBOPause', 'SPFM_CREATE', 'SpUnCompressedLexicon',
    'SAFT48kHz16BitMono', 'DISPIDSPTSI_ActiveLength', 'SPEI_MIN_TTS',
    'DISPID_SpeechLexiconWords', 'SpStreamFormatConverter',
    'DISPID_SRGCmdLoadFromMemory', 'SVP_14', 'SPVPRI_NORMAL',
    'DISPID_SPERetainedSizeBytes', 'SPADAPTATIONRELEVANCE',
    'SP_VISEME_13', 'SAFT8kHz8BitMono', 'eLEXTYPE_LETTERTOSOUND',
    'SPPHRASERULE', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SABIMinNotification', 'DISPID_SPIRetainedSizeBytes',
    'SDTReplacement', 'SPEI_RESERVED6', 'SAFT48kHz8BitMono',
    'SRSInactiveWithPurge', 'SpeechGrammarState',
    'DISPID_SpeechPhoneConverter', 'DISPID_SWFEChannels',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SRGSetTextSelection', 'SWTAdded', 'SAFT22kHz8BitMono',
    'SpeechLoadOption', 'SPGS_EXCLUSIVE', 'DISPID_SOTs_NewEnum',
    'SPEVENT', 'SVSFIsXML', 'SREAudioLevel', 'SPAR_Low',
    'eLEXTYPE_PRIVATE18', 'SRAExport', 'SRADynamic',
    'SAFT16kHz8BitMono', 'DISPID_SGRClear', 'SpeechVoiceSpeakFlags',
    'SPCS_ENABLED', 'SP_VISEME_3', 'SpeechWordPronounceable',
    'eLEXTYPE_PRIVATE10', 'DISPID_SpeechPhraseReplacements',
    'SRSEDone', 'SECFIgnoreCase', 'DISPID_SRRAudio',
    'SAFTGSM610_44kHzMono', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SVWaitUntilDone', 'SpeechAudioFormatGUIDText',
    'DISPID_SAFType', 'DISPID_SpeechObjectToken',
    'DISPID_SpeechLexiconPronunciation', 'SPSMF_SAPI_PROPERTIES',
    'ISpeechVoice', 'SpPhoneConverter', 'SPEVENTENUM',
    'SDA_Two_Trailing_Spaces', 'SPSLMA', 'eLEXTYPE_PRIVATE19',
    'STSF_FlagCreate', 'DISPID_SPIStartTime',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SRRTOffsetFromStart',
    'SPSHORTCUTPAIRLIST', 'ISpRecoGrammar', 'ISpeechObjectTokens',
    'DISPID_SPAs_NewEnum', 'DISPID_SDKSetBinaryValue',
    'SPWT_PRONUNCIATION', 'DISPID_SpeechObjectTokens',
    'DISPID_SASState', 'SPFM_OPEN_READWRITE', 'SVP_11',
    'DISPID_SpeechLexicon', 'SpLexicon', 'IInternetSecurityMgrSite',
    'SVP_16', 'SpInprocRecognizer', 'SPINTERFERENCE_TOOSLOW',
    'SpeechCategoryRecoProfiles', 'SRESoundStart', 'SVP_5',
    'SpeechFormatType', 'DISPID_SGRSTransitions',
    'SAFT44kHz16BitMono', 'DISPID_SPIAudioStreamPosition',
    'STSF_AppData', 'SpeechPropertyLowConfidenceThreshold',
    'SAFTCCITT_ALaw_22kHzMono', 'SPAR_Medium', 'DISPID_SAVolume',
    'SAFTCCITT_uLaw_22kHzStereo', 'SpeechCategoryPhoneConverters',
    'SECFNoSpecialChars', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SASCurrentSeekPosition', 'ISpeechPhraseInfoBuilder',
    'DISPID_SpeechVoice', 'DISPID_SpeechGrammarRuleState', 'SVP_18',
    'SPSHT_Unknown', 'SpeechInterference',
    'DISPID_SRSSupportedLanguages', 'SpeechTokenValueCLSID',
    'SAFT12kHz16BitMono', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SDKEnumKeys', 'DISPID_SRCEEnginePrivate',
    'DISPID_SASFreeBufferSpace', 'DISPID_SRCEPropertyNumberChange',
    'ISpeechObjectTokenCategory', 'SPEI_TTS_PRIVATE', 'SDTAudio',
    'SGDisplay', 'SREPrivate', 'DISPID_SpeechGrammarRules', 'SVP_12',
    'DISPID_SVSVisemeId', 'ISpeechLexiconPronunciations',
    'SSTTDictation', 'SAFT44kHz8BitMono', 'SPCT_SUB_DICTATION',
    'SPINTERFERENCE', 'SpWaveFormatEx', 'SPAUDIOBUFFERINFO',
    'DISPID_SVEBookmark', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SCSBaseStream', 'ISpPhoneConverter', 'SVP_20',
    'DISPID_SRGetPropertyString', 'SGLexical', 'DISPID_SPAsCount',
    'SVSFlagsAsync', 'DISPID_SVEStreamStart',
    'DISPID_SAFGetWaveFormatEx', 'SP_VISEME_4',
    'DISPID_SpeechPhraseProperties', 'ISpeechDataKey',
    'DISPID_SRGetFormat', 'DISPID_SOTCategory',
    'DISPID_SpeechPhraseRule', 'SPWORDPRONUNCIATIONLIST',
    'ISpeechResourceLoader', 'DISPID_SpeechDataKey',
    'SDKLCurrentConfig', 'DISPID_SPPChildren', 'SRAONone', 'UINT_PTR',
    'DISPID_SPCPhoneToId', 'DISPID_SPERetainedStreamOffset',
    'WAVEFORMATEX', 'SVEPrivate', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SpeechRecoContext', 'ISpEventSource', 'SPGS_ENABLED',
    'DISPID_SVPause', 'SPXMLRESULTOPTIONS',
    'SpeechGrammarTagDictation', 'DISPID_SLPSymbolic',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SRRDiscardResultInfo',
    'SBONone', 'DISPID_SRState', 'SAFT11kHz16BitStereo',
    'SpObjectTokenCategory', 'DISPID_SpeechPhraseElement',
    'DISPID_SRAudioInput', 'DISPID_SpeechPhraseBuilder',
    'SRATopLevel', 'eLEXTYPE_RESERVED6', 'SPSERIALIZEDPHRASE',
    'DISPID_SPIElements', 'ISpeechRecoResultTimes', 'ISpDataKey',
    'DISPID_SLAddPronunciation', 'DISPID_SPPParent',
    'DISPID_SPIEnginePrivateData', 'DISPID_SGRSTNextState',
    'SPLO_DYNAMIC', 'SGRSTTRule', 'SPGRAMMARWORDTYPE',
    'DISPID_SpeechPhraseAlternates', 'SAFT22kHz16BitStereo',
    'SRTReSent', 'DISPID_SPRuleChildren', 'DISPID_SRSAudioStatus',
    'DISPID_SRCEAdaptation', 'DISPID_SRRAlternates',
    'ISpeechPhraseInfo', 'DISPID_SMSSetData',
    'SAFTCCITT_uLaw_11kHzStereo', 'SVEBookmark', 'SPEI_RESERVED1',
    'ISpeechRecoResultDispatch', 'SRARoot',
    'SpeechPropertyComplexResponseSpeed',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SLWWord',
    'DISPID_SGRsCommit', 'DISPID_SRGDictationLoad',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SRCSetAdaptationData',
    'ISpeechGrammarRuleState', 'SAFT24kHz8BitStereo', 'SVSFParseSsml',
    'SpeechPartOfSpeech', 'SDTAlternates', 'SGDSActive',
    'SpeechStreamFileMode', 'SECNormalConfidence',
    'DISPID_SRCRequestedUIType', 'DISPID_SDKOpenKey',
    'DISPID_SRCEInterference', 'SPEI_RECO_OTHER_CONTEXT',
    'ISpRecoGrammar2', 'SPAS_STOP', 'SAFT8kHz8BitStereo',
    'SpeechPropertyAdaptationOn', 'DISPID_SOTMatchesAttributes',
    'SECFDefault', 'SpeechWordType', 'DISPID_SVSRunningState',
    'DISPID_SWFEExtraData', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SPEI_HYPOTHESIS', 'DISPID_SRGCommit', 'DISPID_SGRAddResource',
    'DISPID_SRGetRecognizers', 'DISPID_SVSyncronousSpeakTimeout',
    'SPCT_SUB_COMMAND', 'SPEI_TTS_BOOKMARK', 'SPSMF_UPS',
    'SP_VISEME_16', 'DISPID_SPIReplacements', 'DISPID_SPEs_NewEnum',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPVPRI_OVER',
    'SDKLDefaultLocation', 'SpSharedRecognizer',
    'DISPID_SVSLastResult', 'SPEI_WORD_BOUNDARY', 'LONG_PTR',
    'DISPID_SVAudioOutputStream', 'ISpMMSysAudio', 'DISPID_SVEWord',
    'DISPID_SDKDeleteValue', 'DISPID_SRRRecoContext', 'SRSActive',
    'SpeechCategoryAudioOut', 'DISPID_SWFEBlockAlign',
    'SSFMCreateForWrite', 'DISPID_SOTGetAttribute',
    '_RemotableHandle', 'DISPID_SPIGrammarId', 'DISPID_SAEventHandle',
    'DISPID_SVGetVoices', 'SPEI_SOUND_END', 'DISPID_SVEEnginePrivate',
    'SSTTWildcard', 'SP_VISEME_20', 'SAFTCCITT_ALaw_11kHzMono',
    'ISpNotifySource', 'DISPID_SRRTimes', 'SPSHT_EMAIL',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'DISPID_SLGetWords',
    'DISPID_SVPriority', 'SAFTGSM610_22kHzMono',
    'DISPID_SGRSTPropertyId', 'eLEXTYPE_PRIVATE11',
    'SAFTGSM610_11kHzMono', 'SPVOICESTATUS',
    'DISPID_SRCEventInterests', 'DISPID_SPIAudioSizeTime',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SPAsItem', 'SPSHORTCUTPAIR',
    'ISpPhraseAlt', 'SpeechVoicePriority', 'DISPID_SGRInitialState',
    'SINone', 'SpeechGrammarRuleStateTransitionType', 'SPSHT_OTHER',
    'DISPID_SBSSeek', 'Speech_StreamPos_Asap',
    'SpPhoneticAlphabetConverter', 'SVF_Stressed',
    'ISpeechLexiconWord', 'SRTExtendableParse', 'DISPID_SGRSTType',
    'ISpRecognizer2', 'DISPID_SRGRules', 'DISPID_SPEPronunciation',
    'DISPID_SVSpeak', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'ISpeechCustomStream', 'SPEI_SOUND_START', 'SP_VISEME_10',
    'DISPID_SDKCreateKey', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SLWType', 'SPEI_RESERVED5', 'SREFalseRecognition',
    'SASPause', 'DISPID_SRCEStartStream',
    'SPRS_ACTIVE_USER_DELIMITED', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SMSALineId', 'ISpPhoneticAlphabetSelection',
    'SAFT12kHz16BitStereo', 'SPEI_ADAPTATION',
    'ISpeechGrammarRuleStateTransitions',
    'DISPID_SVSLastStreamNumberQueued', 'SWPUnknownWordPronounceable',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SPRuleId',
    'SpeechTokenIdUserLexicon', 'ISpeechPhraseReplacement',
    'SpeechAddRemoveWord', 'SPCT_DICTATION', 'SPSVerb',
    'SPPROPERTYINFO', 'DISPID_SPRuleFirstElement',
    'DISPID_SWFEFormatTag', 'DISPID_SLPType', 'SPAUDIOSTATE',
    'SP_VISEME_8', 'SPDKL_LocalMachine', 'DISPID_SRCEHypothesis',
    'SRAImport', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SOTCGetDataKey', 'DISPID_SDKGetStringValue',
    'DISPID_SpeechWaveFormatEx', 'SAFT22kHz8BitStereo',
    'DISPID_SVESentenceBoundary', 'SRTAutopause',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SPRText',
    'DISPID_SLGetGenerationChange', 'DISPID_SLWsCount',
    'IInternetSecurityManager', 'DISPID_SpeechAudioStatus',
    'DISPID_SVVolume', 'SFTInput', 'DISPID_SPPNumberOfElements',
    'DISPID_SRCERecognition', 'SAFT11kHz8BitMono',
    'DISPID_SPEAudioSizeBytes', 'SVSFParseAutodetect',
    'SRERecoOtherContext', 'DISPID_SGRsDynamic', 'tagSPPROPERTYINFO',
    'ISpSerializeState', 'SPEI_PHONEME', 'DISPID_SOTSetId',
    'SPAO_RETAIN_AUDIO',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SAFTADPCM_22kHzStereo', 'SPGS_DISABLED', 'SVEPhoneme',
    'SpeechCategoryVoices', 'DISPID_SLPsItem', 'eLEXTYPE_RESERVED7',
    'DISPID_SPRsCount', 'DISPID_SRRSetTextFeedback', 'SREHypothesis',
    'SPRECORESULTTIMES', 'ISpeechAudioStatus', 'ISpeechPhraseRules',
    'SVSFParseSapi', 'SPPS_NotOverriden', 'DISPID_SAFGuid', 'SVP_0',
    'SVP_15', 'ISpObjectWithToken', 'SRADefaultToActive',
    'DISPID_SGRsAdd', 'SREStreamEnd', 'eLEXTYPE_PRIVATE16',
    'SPAO_NONE', 'SPEI_END_INPUT_STREAM', 'SPCONTEXTSTATE', 'SINoise',
    'DISPID_SLPPartOfSpeech', 'SPRECOSTATE', 'SPRULESTATE',
    'DISPID_SpeechPhraseInfo', 'SpeechAudioState', 'SSFMOpenForRead',
    'SGPronounciation', 'SVP_9', 'DISPID_SASetState',
    'ISpeechPhraseProperties', 'ISpeechGrammarRules',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SPAPhraseInfo',
    'DISPID_SGRId', 'DISPID_SRRecognizer', 'SPBINARYGRAMMAR',
    'ISpeechObjectToken', 'SPVISEMES', 'SITooQuiet',
    'SpeechRecoProfileProperties', 'DISPID_SVEVoiceChange',
    'SDKLCurrentUser', 'SpMemoryStream',
    'DISPID_SpeechAudioBufferInfo', 'SPSNoun', 'ISpRecognizer3',
    'SVEStartInputStream', 'DISPID_SLWPronunciations',
    'DISPID_SpeechRecoContextEvents', 'SPPS_Noncontent',
    'DISPIDSPTSI', 'SpInProcRecoContext', 'SRSInactive',
    'ISpeechLexicon', 'SLOStatic', 'SAFTCCITT_uLaw_44kHzMono',
    'SDTProperty', 'DISPID_SPRulesCount', 'DISPID_SRSClsidEngine',
    'SPDKL_DefaultLocation', 'SpeechVisemeType', 'DISPID_SRStatus',
    'ISpeechWaveFormatEx', 'SPFILEMODE', 'SPAR_High',
    'SVESentenceBoundary', 'SVP_7', '_ISpeechVoiceEvents',
    'DISPID_SRRTStreamTime', 'DISPID_SpeechLexiconWord',
    'IEnumSpObjectTokens', 'SSTTTextBuffer',
    'DISPID_SVSInputSentencePosition', 'eLEXTYPE_PRIVATE13',
    'DISPID_SGRSTsItem', 'SPEI_VOICE_CHANGE',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SRSNumberOfActiveRules', 'SP_VISEME_14', 'SINoSignal',
    'DISPID_SOTCSetId', 'DISPID_SASCurrentDevicePosition', 'SLTApp',
    'SPDKL_CurrentUser',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'eLEXTYPE_PRIVATE4', 'DISPID_SVSInputWordPosition',
    'ISpeechMemoryStream', 'SPSTREAMFORMATTYPE',
    'DISPID_SOTGetStorageFileName', 'SECFIgnoreWidth',
    'DISPID_SASNonBlockingIO', 'DISPID_SLPs_NewEnum', 'SVEAudioLevel',
    'SAFT24kHz16BitStereo', 'ISpeechPhraseElements', 'SVSFDefault',
    'ISpGrammarBuilder', 'SAFT32kHz16BitStereo',
    'DISPID_SpeechGrammarRuleStateTransition', 'SDTPronunciation',
    'SGLexicalNoSpecialChars', 'DISPID_SVGetAudioInputs',
    'DISPID_SRCESoundEnd', 'DISPID_SpeechRecoResult', 'SVP_4',
    'DISPID_SRCERequestUI', 'DISPID_SRRSpeakAudio',
    'SpeechMicTraining', 'SPGRAMMARSTATE',
    'DISPID_SPRNumberOfElements'
]

_check_version('1.1.14', 1623303389.761770)
